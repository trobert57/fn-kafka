...
#fn update app fn-kafka-app --config KAFKA_BROKERS=129.146.80.113:6667 --config TOPIC_NAME=alexanderTopic
# Use Kafka running on Oracle Event Hub from FN Cloud Service
fn update app fn-kafka-app --annotation oracle.com/oci/subnetIds='["ocid1.subnet.oc1.iad.aaaaaaaaxrpre3meci53mgajfa6q45jvq2ffkeq763sq7qyhjlppnwrujcqa"]' --config KAFKA_BROKERS=129.146.80.113:6667 --config TOPIC_NAME=alexanderTopic --syslog-url tcp://logs7.papertrailapp.com:36791
